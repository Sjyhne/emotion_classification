...
from vggish.vggish import create_and_save_features
...
if images == True:
    ...
    if test_data_size != None:
        target_dir = "vggish_audio_features_" + str(test_data_size)
    else:
        target_dir = "vggish_audio_features"
else:
    if test_data_size != None:
...
if images and v2:
    ...
    print("Constructing and saving vggish features")

    create_and_save_features(train_data, target_dir, "train")
    create_and_save_features(test_data, target_dir, "test")
    create_and_save_features(val_data, target_dir, "val")
